    ...
    <div data-theme={tema}>
      ...
      <div className='h-screen pt-25 dark:bg-purple bg-whiteBg md:pt-35'>
        <div className='flex flex-col items-center justify-center md:flex-row md:px-20'>
          <div className='text-blue font-OpenSans w-sm dark:text-whiteBg md:w-4xl'>
            ...
            <p className='text-center px-10 py-5 text-lg md:text-3xl md:w-3xl md:py-10 justify-center'>Em CortexID Game, você escolhe seu
              ...
              {isMobile == false? <div className='flex items-center justify-center pr-30'><a className='flex items-center justify-center text-whiteBg text-4xl gap-4 bg-blue rounded-4xl px-25 py-5 mt-10 dark:bg-light-blue' href="https://www.google.com/?hl=pt_BR">Jogar <img src={jogar} alt="" /></a></div> : ""}
          </div>
