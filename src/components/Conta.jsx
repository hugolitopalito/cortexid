            ...
            <div className='flex justify-center items-center h-screen bg-whiteBg dark:bg-purple pt-15'>
                <div className='bg-blue text-whiteBg rounded-4xl pt-10 px-5 w-2xs dark:bg-dark-blue md:w-md'>
                    <div className='text-center justify-center items-center flex flex-col gap-2'>
                        ...
                        <button className='underline md:text-xl cursor-pointer'>Alterar imagem</button>
                    </div>
                    <div className='flex justify-between items-center pt-8 border-b'>
                        ...
                        <button>
                        <img src={editar} className='md:h-8 md:w-9 cursor-pointer' alt="" />
                        </button>
                    </div>
                    ...
                    <div className='flex items-center justify-center'>
                        <button className='bg-whiteBg text-blue text-lg font-OpenSans font-bold py-4 px-20 rounded-4xl my-10 dark:bg-light-blue dark:text-whiteBg md:text-2xl cursor-pointer'>
                            Salvar
                        </button>
                    </div>
                </div>
