...
export const HomeMain = () => {
    return (
        <div className='flex justify-center items-center flex-col pt-20'>
            ...
            <div>
            <h2 className='font-OpenSans font-bold text-blue w-3xs text-3xl'>Você reconhece todo mundo & eles não</h2>
            ...
            <button className='font-OpenSans font-bold  bg-blue rounded-full w-3xs p-2 '>
